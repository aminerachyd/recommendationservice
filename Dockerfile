...
RUN ARCH=$(uname -m) yum https://rpmfind.net/linux/centos/8-stream/PowerTools/$ARCH/os/Packages/libstdc++-static-8.5.0-10.el8.$ARCH.rpm install -y sudo wget make gcc-c++ && yum clean all
